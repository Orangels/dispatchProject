...
int main()
{
    ...
    Engine_api *pPer_0 = new Engine_api();
    Engine_api *pPer_1 = new Engine_api();
    Engine_api *pPer_2 = new Engine_api();

    auto thread_func_0 = [&](){
        pPer_0->get_result(img0.clone());
        LOG_DEBUG("pPer 0 \n");
    };

    auto thread_func_1 = [&](){
        pPer_1->get_result(img0.clone());
        LOG_DEBUG("pPer 1 \n");
    };

    auto thread_func_2 = [&](){
        pPer_2->get_result(img0.clone());
        LOG_DEBUG("pPer 2 \n");
    };
