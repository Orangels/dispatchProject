...
public:
    cameraHandler(int vInput_width, int vInput_height, unsigned char *vInput_data,
               ...
               float vCenter_zoom_angle, int InferMode=1);

    cameraHandler(int vInput_width, int vInput_height, unsigned char *vInput_data,
                  int vOutput_width, int vOutput_height, unsigned char *vOutput_data,
               float vPerimeter_top_angle, float vPerimeter_bottom_angle, int InferMode=1);
...
private:
    cameraHandler(int vInput_width, int vInput_height, unsigned char *vInput_data,
                  int vOutput_width, int vOutput_height, unsigned char *vOutput_data, int InferMode=0);
