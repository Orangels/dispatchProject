...
//        auto center_reader = [&](){
        int64_t start_center = getCurrentTime();
        camera_center->run(src.data);
        int64_t end_center = getCurrentTime();
        cout << "center frame num : " << frame_num << " cost : " << end_center-start_center << endl;
//        };
